...
@onready
var weapon_damage_text = $WeaponContainer/WeaponStatContainer/DamageTextContainer/DamageTextLabel
...
@onready
var armor_multiplier_text = $ArmorContainer/ArmorStatContainer/MultiplierTextContainer/MultiplierTextLabel
